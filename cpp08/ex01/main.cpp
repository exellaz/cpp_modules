...
/*   Updated: 2025/04/24 18:24:56 by kkhai-ki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << YELLOW << "[Test] Exceptions" << RESET << "\n";
	Span span(2);
	try {
		span.addNumber(1);
		span.addNumber(2);
		span.addNumber(3); // should throw
	}
	...
	try {
		...
		smallSpan.shortestSpan(); // should throw
	}
	catch (const std::exception& e) {
	...
	try {
		...
		smallSpan.longestSpan(); // should throw
	}
	catch (const std::exception& e) {
